...
{
	private static final String SYSTEMCACHE = "vipcache";
	...
	protected void onPreOnCreate(Bundle savedInstanceState)
	{
		...
		// 注册activity
		getTAApplication().registerActivity(R.string.vipmainactivity,
				VipMainActivity.class);
		// 注册activity
		getTAApplication().registerActivity(R.string.vipvideoactivity,
				VipVideoActivity.class);
		// 注册activity
		getTAApplication().registerActivity(R.string.vippptactivity,
				VipPptActivity.class);
		// 注册activity
		getTAApplication().registerActivity(R.string.viparticleactivity,
				VipArticleActivity.class);
		// 注册activity
		getTAApplication().registerActivity(R.string.vipvideodetailactivity,
				VipVideoDetailActivity.class);
		// 注册activity
		getTAApplication().registerActivity(R.string.vippptdetailactivity,
				VipPptDetailActivity.class);
		// 注册activity
		getTAApplication().registerActivity(R.string.viparticledetailactivity,
				VipArticleDetailActivity.class);
		// 注册activity
